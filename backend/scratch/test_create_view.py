...
try:
    ...
    # Test 1: CREATE VIEW without semicolon
    sql1 = f'CREATE VIEW EKKO AS SELECT * FROM "{master_pool.id}"."EKKO"'
    print("Testing Test 1 (CREATE VIEW without semicolon)...")
    ...
    # Test 2: CREATE VIEW with double quotes
    sql2 = f'CREATE VIEW "EKKO" AS SELECT * FROM "{master_pool.id}"."EKKO"'
    print("\nTesting Test 2 (CREATE VIEW with double quotes on view name)...")
