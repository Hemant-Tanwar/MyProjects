    ...
    def _mock_response(self, prompt: str) -> str:
        ...
        if "o2c" in p_lower or "order-to-cash" in p_lower or "order to cash" in p_lower or "sales" in p_lower:
            ...
            mock_sql = (
                ...
                "        mseg.BUDAT AS EVENT_TIME,\n"
                "        mseg.USNAM AS USER_NAME,\n"
                "        20 AS SORT_INDEX\n"
                "    FROM MSEG mseg\n"
